...
function ContactUs() {
    ...
    return (
        <div className='flex items-center'>
            ...
            <div className=" min-h-screen flex justify-between items-center flex-grow max-w-md" style={{ color: mode === 'dark' ? 'white' : '', }}>
                <div className="bg-gray-300 rounded-lg  p-8 shadow-md w-full">
